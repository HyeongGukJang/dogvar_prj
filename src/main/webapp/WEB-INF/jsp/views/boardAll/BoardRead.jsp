...
function fn_replyDelete(reno){
	...
	form.action="boardAllReplyDelete";
...
<body>
		...
		<a href="boardAllList">돌아가기</a>
		<a href="boardAllDelete?brdno=<c:out value="${boardInfo.brdno}"/>">삭제</a>
		<a href="boardAllForm?brdno=<c:out value="${boardInfo.brdno}"/>">수정</a>
		<p>&nbsp;</p>
		<div style="border: 1px solid; width: 600px; padding: 5px">
			<form name="form1" action="boardAllReplySave" method="post">
		...
		<div id="replyDiv" style="width: 99%; display:none">
			<form name="form2" action="boardAllReplySave" method="post">
				<input type="hidden" name="brdno" value="<c:out value="${boardInfo.brdno}"/>"> 
		...
		<div id="replyDialog" style="width: 99%; display:none">
			<form name="form3" action="boardAllReplySave" method="post">
				<input type="hidden" name="brdno" value="<c:out value="${boardInfo.brdno}"/>"> 
				<input type="hidden" name="reno"> 
